...
public class CreateStudent {
    public static void main(String[] args) {
        ...
        try {
            ...
            studentFromDB.setEmail("zmenenymail@gmail.com");
            System.out.println("Set complete"+studentFromDB.getEmail());
            session.createQuery("update Student set email='novyemailprevšetkych@gmail.com'").executeUpdate();
            session.getTransaction().commit();
        }finally {
            session.close();
        }
